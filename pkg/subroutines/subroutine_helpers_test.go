...
func (s *HelperTestSuite) TestApplyManifestFromFile() {
	...
	err = subroutines.ApplyManifestFromFile(ctx, "../../manifests/kcp/04-platform-mesh/mutatingwebhookconfiguration-admissionregistration.k8s.io.yaml", cl, templateData, "root:platform-mesh-system", &corev1alpha1.PlatformMesh{})
	s.Assert().Nil(err)
}
