...
func TestRenderPresetGroupsTemplatedManifestsByWorkspace(t *testing.T) {
	...
	raw := []byte(`apiVersion: rbacpresets.platform-mesh.io/v1alpha1
...
`,
		...
		},
		{
			...
			raw: `apiVersion: rbacpresets.platform-mesh.io/v1alpha1
kind: ProviderRBACPreset
metadata:
  name: one
spec:
  serverTarget:
    type: workspaceCluster
---
apiVersion: rbacpresets.platform-mesh.io/v1alpha1
kind: ProviderRBACPreset
metadata:
  name: two
spec:
