...
replace ocm.software/open-component-model/kubernetes/controller => github.com/open-component-model/open-component-model/kubernetes/controller v0.0.0-20260224082343-7434564d64aa
...
require (
	...
	github.com/platform-mesh/golang-commons v0.12.1
