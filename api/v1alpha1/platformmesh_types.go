...
// KubeconfigAuth defines how provider kubeconfigs authenticate to kcp.
type KubeconfigAuth string

const (
	// KubeconfigAuthAdminKubeconfig keeps cert-based auth from kubeconfig-kcp-admin.
	KubeconfigAuthAdminKubeconfig KubeconfigAuth = "adminKubeconfig"
	// KubeconfigAuthServiceAccountScoped creates a scoped ServiceAccount token kubeconfig.
	KubeconfigAuthServiceAccountScoped KubeconfigAuth = "serviceAccountScoped"
)
...
type ProviderConnection struct {
	...
	Namespace         *string `json:"namespace,omitempty"`
	// +kubebuilder:validation:Enum=adminKubeconfig;serviceAccountScoped
	KubeconfigAuth KubeconfigAuth `json:"kubeconfigAuth,omitempty"`
