...
replace ocm.software/open-component-model/kubernetes/controller => github.com/open-component-model/open-component-model/kubernetes/controller v0.0.0-20260122112558-5719865dc1e5
...
require (
	...
	github.com/platform-mesh/golang-commons v0.9.22
