...
func (in *ProviderConnection) DeepCopyInto(out *ProviderConnection) {
	*out = *in
	...
	if in.ServiceAccountPermissions != nil {
		in, out := &in.ServiceAccountPermissions, &out.ServiceAccountPermissions
		*out = new(ServiceAccountPermissions)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ServiceAccountPermissions) DeepCopyInto(out *ServiceAccountPermissions) {
	*out = *in
	if in.RootOrgAccess != nil {
		in, out := &in.RootOrgAccess, &out.RootOrgAccess
		*out = new(bool)
		**out = **in
	}
	if in.EnableGetLogicalCluster != nil {
		in, out := &in.EnableGetLogicalCluster, &out.EnableGetLogicalCluster
		*out = new(bool)
		**out = **in
	}
	if in.EnableStoresAccess != nil {
		in, out := &in.EnableStoresAccess, &out.EnableStoresAccess
		*out = new(bool)
		**out = **in
	}
	if in.EnableInitTargetsAccess != nil {
		in, out := &in.EnableInitTargetsAccess, &out.EnableInitTargetsAccess
		*out = new(bool)
		**out = **in
	}
	if in.EnableWorkspaceTypesAccess != nil {
		in, out := &in.EnableWorkspaceTypesAccess, &out.EnableWorkspaceTypesAccess
		*out = new(bool)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ServiceAccountPermissions.
func (in *ServiceAccountPermissions) DeepCopy() *ServiceAccountPermissions {
	if in == nil {
		return nil
	}
	out := new(ServiceAccountPermissions)
